<?php
	...
	if(isset($_POST['btnacao'])){
		...
		$sql_confere = "SELECT senha FROM tbl_usuario WHERE id_usuario = $id_usuario AND corretora_id = ".CORRETORA." AND ativo = 1";
		...
		if(empty($erro)){
			...
			WHERE id_usuario = $id_usuario AND corretora_id = ".CORRETORA." AND ativo = 1";

<?php
	...
	if(isset($_POST["btnacao"])){
	   ...
	   $senha      = $_POST['senha'];
		...
		$sql_login = "SELECT login, corretora_id from tbl_usuario WHERE login = '$login' AND corretora_id = ".CORRETORA."";
        ...
        if(empty($erro)){ //se erro estiver vazio
            if($id_usuario == 0){
                $sql = "INSERT INTO tbl_usuario (nome, email, login, senha, corretora_id)  
                VALUES ('$nome', '$email', '$login', '$hash', ".CORRETORA.")";
            }
